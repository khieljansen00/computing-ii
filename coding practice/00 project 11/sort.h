...
//   >0 if right comes first in the ordering
//   ==0 if they are equal
...
// postcondition:
//   returns true if the list is sorted under the given comparison function
//   and false otherwise
...
//   compare is a comparison function
// postcondition:
//   The elements of array will be reordered so that they are in increasing
//   order under the given comparison function
